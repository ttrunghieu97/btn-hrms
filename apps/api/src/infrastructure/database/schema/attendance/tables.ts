...
export const attendanceDailySummaries = pgTable(
  "attendance_daily_summaries",
  {
    ...
    personalBreakMinutes: integer("personal_break_minutes").default(0).notNull(),
    lunchDutyMinutes: integer("lunch_duty_minutes").default(0).notNull(),
    nightShiftDutyCount: numeric("night_shift_duty_count", { precision: 5, scale: 2 }).default("0").notNull(),
    waterBoothDutyCount: numeric("water_booth_duty_count", { precision: 5, scale: 2 }).default("0").notNull(),
